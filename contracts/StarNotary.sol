...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((owner1 == msg.sender || owner2 == msg.sender), "Exchange must be initiated by an owner of one of the stars");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(owner == msg.sender, "Transfer must be initiated by star owner");
